...
THEME = \
	$(wildcard metis/*.png) \
	metis/theme.txt \
	metis/u_vga16_16.pf2

ICONS= $(wildcard metis/icons/*.png)
...
install_theme:
	install $(DMODE) $(DESTDIR)$(PREFIX)/share/grub/themes/metis
	install $(FMODE) $(THEME) $(DESTDIR)$(PREFIX)/share/grub/themes/metis

	install $(DMODE) $(DESTDIR)$(PREFIX)/share/grub/themes/metis/icons
